...
void test() {
    T t = 2;
    T u = 2;
    BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (int)FP_NORMAL);
    BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(-t), (int)FP_NORMAL);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(t), true);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(-t), true);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(t), false);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(-t), false);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(t), false);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(-t), false);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(t), true);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(-t), true);
    BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (nil::crypto3::math::fpclassify)(t + 0));
    ...
    if (std::numeric_limits<T>::has_denorm) {
        ...
        t /= 2;
        if (t != 0) {
            BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (int)FP_SUBNORMAL);
            BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(-t), (int)FP_SUBNORMAL);
            BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(t), true);
            BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(-t), true);
            BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(t), false);
            ...
            BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(t), false);
            BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(-t), false);
            BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(t), false);
            BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(-t), false);
            BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (nil::crypto3::math::fpclassify)(t + 0));
        }
    ...
    t = 0;
    BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (int)FP_ZERO);
    BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(-t), (int)FP_ZERO);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(t), true);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(-t), true);
    BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(t), false);
    ...
    if (std::numeric_limits<T>::has_infinity) {
        ...
        BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (int)FP_INFINITE);
        BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(-t), (int)FP_INFINITE);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(-t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(t), true);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(-t), true);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(-t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(t), false);
    ...
    if (std::numeric_limits<T>::has_quiet_NaN) {
        ...
        BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(t), (int)FP_NAN);
        BOOST_CHECK_EQUAL((nil::crypto3::math::fpclassify)(-t), (int)FP_NAN);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isfinite)(-t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isinf)(-t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(t), true);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnan)(-t), true);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(t), false);
        BOOST_CHECK_EQUAL((nil::crypto3::math::isnormal)(-t), false);
    } else {
