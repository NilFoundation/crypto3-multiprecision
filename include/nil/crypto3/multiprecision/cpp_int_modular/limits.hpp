...
#pragma warning(disable : 4307)
        ...
        inline BOOST_CXX14_CONSTEXPR_IF_DETECTION boost::multiprecision::number<
            nil::crypto3::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>
    ...
    template<unsigned Bits,
             boost::multiprecision::expression_template_option ExpressionTemplates>
    constexpr int numeric_limits<boost::multiprecision::number<
        nil::crypto3::multiprecision::backends::cpp_int_modular_backend<Bits>,
    ...
    template<unsigned Bits,
             boost::multiprecision::expression_template_option ExpressionTemplates>
    constexpr bool numeric_limits<boost::multiprecision::number<
        nil::crypto3::multiprecision::backends::cpp_int_modular_backend<Bits>,
    ...
    template<unsigned Bits,
             boost::multiprecision::expression_template_option ExpressionTemplates>
    constexpr float_denorm_style numeric_limits<boost::multiprecision::number<
        nil::crypto3::multiprecision::backends::cpp_int_modular_backend<Bits>,
