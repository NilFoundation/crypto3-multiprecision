...
#include <boost/multiprecision/traits/conditional_make_unsigned.hpp>
        ...
        namespace multiprecision {
            ...
            namespace detail {
                ...
                number<cpp_int_modular_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>&
                    ...
                    using unsigned_value_type = typename boost::multiprecision::detail::conditional_make_unsigned<value_type>::type;
