...
#ifndef CRYPTO3_MP_INTEL_INTRINSICS_HPP
#define CRYPTO3_MP_INTEL_INTRINSICS_HPP
//
// Select which actual implementation header to use:
//
#ifdef __has_include
#if __has_include(<immintrin.h>)
#define CRYPTO3_MP_HAS_IMMINTRIN_H
#endif
#endif
//
...
#if !__has_builtin(__builtin_ia32_addcarryx_u64) && defined(CRYPTO3_MP_HAS_IMMINTRIN_H) && \
    !(defined(BOOST_GCC) && (__GNUC__ >= 9))
#undef CRYPTO3_MP_HAS_IMMINTRIN_H
#endif
#elif defined(CRYPTO3_MP_HAS_IMMINTRIN_H) && defined(__GNUC__) && !(defined(BOOST_GCC) && (__GNUC__ >= 9))
#undef CRYPTO3_MP_HAS_IMMINTRIN_H
#endif
...
#define CRYPTO3_MP_ADDC __builtin_ia32_addcarryx_u
#endif

#if __has_builtin(__builtin_ia32_subborrow_u64)
#define CRYPTO3_MP_SUBB __builtin_ia32_subborrow_u
#elif __has_builtin(__builtin_ia32_sbb_u64)
#define CRYPTO3_MP_SUBB __builtin_ia32_sbb_u
#endif

#endif

#ifndef CRYPTO3_MP_ADDC
#define CRYPTO3_MP_ADDC _addcarry_u
#endif
#ifndef CRYPTO3_MP_SUBB
#define CRYPTO3_MP_SUBB _subborrow_u
#endif
        ...
        namespace multiprecision {
            namespace detail {
...
#endif
                    return BOOST_JOIN(CRYPTO3_MP_ADDC, 64)(carry, a, b, reinterpret_cast<cast_type*>(p_result));
                }
                ...
                BOOST_MP_FORCEINLINE unsigned char subborrow_limb(unsigned char carry, limb_type a, limb_type b,
                    ...
                    using cast_type = unsigned long long;
#endif
                    return BOOST_JOIN(CRYPTO3_MP_SUBB, 64)(carry, a, b, reinterpret_cast<cast_type*>(p_result));
                }
    ...
    namespace crypto3 {
        namespace multiprecision {
            namespace detail {
                ...
                BOOST_MP_FORCEINLINE unsigned char addcarry_limb(unsigned char carry, limb_type a, limb_type b,
                                                                 limb_type* p_result) {
                    return BOOST_JOIN(CRYPTO3_MP_ADDC, 32)(carry, a, b, reinterpret_cast<unsigned int*>(p_result));
                }

                BOOST_MP_FORCEINLINE unsigned char subborrow_limb(unsigned char carry, limb_type a, limb_type b,
                                                                  limb_type* p_result) {
                    return BOOST_JOIN(CRYPTO3_MP_SUBB, 32)(carry, a, b, reinterpret_cast<unsigned int*>(p_result));
                }
